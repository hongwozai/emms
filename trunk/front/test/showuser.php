...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<li class="macro-component-tabitem current" app-id="114Admin" app-name="显示用户列表"><span class="macro-tabs-item-text">用户列表</span><a class="macro-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="macro-component-tabclose-icon">×</b></a></li></ul>
	...
	<div class="page-content" id="content" style="height: 345px;">
			...
			<iframe style="width:100%;height: 100%;" frameborder="0" class="appiframe" src="../test/frame/userlist.php" id="appiframe-114Admin"></iframe>
		</div>
