...
<body style="min-width:900px;" screen_capture_injected="true">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="macro-component-tab" id="task-content-inner" style="width: 118px; margin-left: 0px;">
					<li class="macro-component-tabitem noclose" app-id="0"  app-name="首页">
						...
						<li class="macro-component-tabitem current" app-id="120Admin" app-name="日志管理">
				<span class="macro-tabs-item-text">日志管理</span>
    ...
    <iframe src="../test/frame/log.php" style="width: 100%; height: 100%; display: block;" frameborder="0" id="appiframe-120Admin" class="appiframe"></iframe>
