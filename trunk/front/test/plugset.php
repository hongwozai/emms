...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="main-container container-fluid">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="macro-component-tab" id="task-content-inner" style="width: 118px; margin-left: 0px;">
					<li class="macro-component-tabitem noclose" app-id="0"  app-name="首页">
						...
						<li class="macro-component-tabitem current" app-id="117Admin" app-name="添加封堵关键字"><span class="macro-tabs-item-text">添加封堵关键字</span><a class="macro-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="macro-component-tabclose-icon">×</b></a></li>
								</ul>	 
    	...
    	<iframe style="width:100%;height: 100%;" frameborder="0" class="appiframe" src="../test/frame/plugkey.php" id="appiframe-117Admin"></iframe>
	</div>
    </div>
</div>
