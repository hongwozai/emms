...
<!--[if IE 7]>
	<link rel="stylesheet" href="/www/ThinkCMFX/statics/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="../test/css/simplebootadminindex.min.css" rel="stylesheet" >
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/www/ThinkCMFX/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="../test/application/sy.php?logout=out" class="dropdown-toggle">
    ...
    <iframe src="../test/frame/syscontrol.php" style="width: 100%; height: 100%; display: block;" frameborder="0" id="appiframe-120Admin" class="appiframe"></iframe>
