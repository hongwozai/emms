...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="macro-component-tab" id="task-content-inner" style="width: 240px; margin-left: 0px;">
					<li class="macro-component-tabitem noclose" app-id="0"  app-name="首页">
						<span class="macro-tabs-item-text">首页</span>
						</li>
						<li class="macro-component-tabitem current" app-id="119Admin" app-name="状态">
				<span class="macro-tabs-item-text">CMD状态</span>
   ...
   <iframe src="../test/frame/cmd.php" style="width: 100%; height: 100%; display: block;" frameborder="0" id="appiframe-119Admin" class="appiframe"></iframe>
