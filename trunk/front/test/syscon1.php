...
<link href="../test/css/res/reset.css" rel="stylesheet">
<link href="../test/css/res/bootstrap.min.css" rel="stylesheet">
<link href="../test/css/res/bootstrap-responsive.min.css" rel="stylesheet">
<link href="../test/css/res/prettify.css" rel="stylesheet">
<link href="../test/css/res/ace.min.css" rel="stylesheet">
<link href="../test/css/res/ace-responsive.min.css" rel="stylesheet">
<link href="../test/css/res/ace-skins.min.css" rel="stylesheet">
<link href="../test/css/res/style_new.css" rel="stylesheet">
<link href="../test/css/res/theme_blue.css" rel="stylesheet">
<link href="../test/css/res/hack.css" rel="stylesheet">-->
<link href="../test/css/res/theme_blue.css" rel="stylesheet">
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="macro-component-tab" id="task-content-inner" style="width: 118px; margin-left: 0px;">
					<li class="macro-component-tabitem noclose" app-id="0"  app-name="首页">
						...
						<li class="macro-component-tabitem current" app-id="120Admin" app-name="添加监测关键字">
				<span class="macro-tabs-item-text">服务器状态</span>
				<a class="macro-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="macro-component-tabclose-icon">×</b></a></li>
			...
			<iframe src="../test/frame/syscontrol1.php" style="width: 100%; height: 100%; display: block;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
    </div>
    </div>
</div>
