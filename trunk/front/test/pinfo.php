...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<li class="macro-component-tabitem current" app-id="113Admin"  app-name="修改用户密码"><span class="macro-tabs-item-text">修改用户密码</span><a class="macro-component-tabclose" href="javascript:void(0)" title="点击关闭标签"><span></span><b class="macro-component-tabclose-icon">×</b></a></li></ul>
	...
	<div class="page-content" id="content" style="height: 345px;">
			...
			<iframe style="width:100%;height: 100%;" frameborder="0" class="appiframe" src="../test/frame/pinfo.php" id="appiframe-113Admin"></iframe>
		</div>
